...
await conn.sendMessage(from, { video: { url: response.result.video_hd }, caption: "> QUEEN DEW \n\n*☘️ Quality SD*" }, { quoted: mek })
await conn.sendMessage(from, { video: { url: response.result.video_sd }, caption: "> QUEEN DEW \n\n*☘️ Quality HD*" }, { quoted: mek })
} catch (e) {
reply(cantf)
console.log(e)
}
