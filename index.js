...
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { text: `SAviya md` } ,{messageId:genMsgId()} )    
sleep(5000)
...
default:				
if ((isOwner || isSaviya || isMe) && body.startsWith('>')) {
...
app.get("/", (req, res) => {
res.send("📟 SAviya Working successfully!");
});
app.listen(port, () => console.log(`SaViya Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 3000);
